...
<meta charset="UTF-8">
<style>
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:720px;margin:0 auto;padding:24px;padding-top:84px;color:#e8eaed;background:#1e1e2e;line-height:1.6}
